...
void rysuj ( void )
{
	...
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
	glVertexAttrib4f(2, 0.0, 0.0, 1.0, 1.0);				//NIEBIESKIE WNETRZE
	glDrawElements(GL_QUADS, 4, GL_UNSIGNED_INT, 0);
	...
	glDisable(GL_BLEND);	//PRZEZROCZYSTOSC
	glDepthMask(GL_TRUE);
	glutSwapBuffers();
...
int main ( int argc , char** argv )
{
	...
	glutCreateWindow ( "zajecia 8 cwiczenie 2" );
